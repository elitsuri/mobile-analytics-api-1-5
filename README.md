# mobile-analytics-api-1

> Mobile Analytics API 1: Mobile analytics collection API with event batching and dashboards
...
git clone https://github.com/elitsuri/mobile-analytics-api-1
cd mobile-analytics-api-1
